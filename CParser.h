...
public:
  ...
  enum {
    RuleProgram = 0, RulePrimaryExpression = 1, RuleGenericSelection = 2, 
    RuleGenericAssocList = 3, RuleGenericAssociation = 4, RulePostfixExpression = 5, 
    RuleArgumentExpressionList = 6, RuleUnaryExpression = 7, RuleUnaryOperator = 8, 
    ...
    RuleDeclarator = 48, RuleDirectDeclarator = 49, RuleVcSpecificModifer = 50, 
    RuleGccDeclaratorExtension = 51, RuleGccAttributeSpecifier = 52, RuleGccAttributeList = 53, 
    RuleGccAttribute = 54, RuleNestedParenthesesBlock = 55, RulePointer = 56, 
    RuleTypeQualifierList = 57, RuleParameterTypeList = 58, RuleParameterList = 59, 
    RuleParameterDeclaration = 60, RuleIdentifierList = 61, RuleTypeName = 62, 
    RuleAbstractDeclarator = 63, RuleDirectAbstractDeclarator = 64, RuleTypedefName = 65, 
    RuleInitializer = 66, RuleInitializerList = 67, RuleDesignation = 68, 
    RuleDesignatorList = 69, RuleDesignator = 70, RuleStaticAssertDeclaration = 71, 
    RuleStatement = 72, RuleLabeledStatement = 73, RuleCompoundStatement = 74, 
    RuleBlockItemList = 75, RuleBlockItem = 76, RuleExpressionStatement = 77, 
